...
def make_histo(df,outfile):
    ...
    ax.set_xticklabels(x_labels,fontsize=14,rotation=315,ha='left')
    ax.set_ylim(0., 1)
    ax.set_ylabel('Percentile (%)', fontsize=14)
    fig.patch.set_facecolor('#ffffe6')
    ax.set_title('TTB Score Summary', fontsize=24)
    plt.tight_layout()
...
if __name__ == '__main__':
    ...
    x_labels, y_values = make_histo(df,'graphs/histogram_ttb.png')
